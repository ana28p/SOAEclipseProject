...
public class PersonNotFoundMessage extends java.lang.Exception{
    ...
    private static final long serialVersionUID = 1555259131432L;
    
    private com.uber.databaseservice.DatabaseServiceStub.FaultMessage faultMessage;
    ...
    public void setFaultMessage(com.uber.databaseservice.DatabaseServiceStub.FaultMessage msg){
       faultMessage = msg;
    }
    
    public com.uber.databaseservice.DatabaseServiceStub.FaultMessage getFaultMessage(){
       return faultMessage;
    }
}
