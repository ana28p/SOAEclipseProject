 ...
 */
            ...
            /**
            *  FindDriverFault bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class FindDriverFault
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":FindDriverFault",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "FindDriverFault",
    ...
    public static class Factory{
        ...
        */
        public static FindDriverFault parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            FindDriverFault object =
                new FindDriverFault();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"FindDriverFault".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (FindDriverFault)com.order.elements.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
