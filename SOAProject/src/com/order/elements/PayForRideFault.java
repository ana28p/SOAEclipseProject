 ...
 */
            ...
            /**
            *  PayForRideFault bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class PayForRideFault
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":PayForRideFault",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "PayForRideFault",
    ...
    public static class Factory{
        ...
        */
        public static PayForRideFault parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            PayForRideFault object =
                new PayForRideFault();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"PayForRideFault".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (PayForRideFault)com.order.elements.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
