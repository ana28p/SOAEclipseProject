 ...
 */
            ...
            /**
            *  GetDistanceFault bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetDistanceFault
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetDistanceFault",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetDistanceFault",
    ...
    public static class Factory{
        ...
        */
        public static GetDistanceFault parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetDistanceFault object =
                new GetDistanceFault();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetDistanceFault".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetDistanceFault)com.order.elements.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
