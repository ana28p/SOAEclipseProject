 ...
 */
            ...
            /**
            *  RatePersonFault bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class RatePersonFault
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":RatePersonFault",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "RatePersonFault",
    ...
    public static class Factory{
        ...
        */
        public static RatePersonFault parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RatePersonFault object =
                new RatePersonFault();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"RatePersonFault".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (RatePersonFault)com.order.elements.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
